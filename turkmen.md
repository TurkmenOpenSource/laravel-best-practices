...
Siz belki  [ ulanyşda bolan Laravel programmalara mysallary](https://github.com/alexeymezenin/laravel-realworld-example-app) görmek islärsiňiz

[![Laravel example app](/images/laravel-real-world-banner.png?raw=true)](https://github.com/alexeymezenin/laravel-realworld-example-app)

## Düzümi

[Ýeke jogapkärçilik düzgüni(Single responsibility principle)](#single-responsibility-principle)

[Uly modeller, kiçi kontrollerler](#fat-models-skinny-controllers)

[Ýaramlylyk (Validation)](#validation)

[Biznes logika hyzmat (service) klasslarda bulmaly](#business-logic-should-be-in-service-class)

[Öz özüňi gaýtalama (DRY)](#dont-repeat-yourself-dry)

[Soraglary guruja (Query Builder) dekerek Eloquent-y ulanmagy saýla. Massiwler(Array) bilen işlemege derek ýygynlar(collections) bilen işlemegi saýla](#prefer-to-use-eloquent-over-using-query-builder-and-raw-sql-queries-prefer-collections-over-arrays)
